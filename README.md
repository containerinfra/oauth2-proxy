...
- docker pull docker.io/containerinfra/oauth2-proxy:7.8.2
- docker pull ghcr.io/containerinfra/oauth2-proxy:7.8.2
...
cosign verify --key cosign.pub docker.io/containerinfra/oauth2-proxy:7.8.2
cosign verify --key cosign.pub ghcr.io/containerinfra/oauth2-proxy:7.8.2
```
