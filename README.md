...
- docker pull docker.io/containerinfra/oauth2-proxy:7.7.0
- docker pull ghcr.io/containerinfra/oauth2-proxy:7.7.0
...
cosign verify --key cosign.pub docker.io/containerinfra/oauth2-proxy:7.7.0
cosign verify --key cosign.pub ghcr.io/containerinfra/oauth2-proxy:7.7.0
```
