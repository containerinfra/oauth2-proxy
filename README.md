...
- docker pull docker.io/containerinfra/oauth2-proxy:7.4.0
- docker pull ghcr.io/containerinfra/oauth2-proxy:7.4.0
...
cosign verify --key cosign.pub docker.io/containerinfra/oauth2-proxy:7.4.0
cosign verify --key cosign.pub ghcr.io/containerinfra/oauth2-proxy:7.4.0
```
